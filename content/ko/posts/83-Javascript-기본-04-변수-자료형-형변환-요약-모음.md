---
title: "Javascript 기본 04 - 변수, 자료형, 형변환 요약 모음"
...
var, let, const를 사용해 변수를 선언할 수 있어. 선언된 변수엔 데이터를 저장할 수 있고.
...
- **alert** 메시지를 보여줘.
- **prompt**사용자에게 텍스트를 입력하라는 메시지를 띄워줌과 동시에, 입력 필드를 함께 제공. 확인을 누르면 prompt 함수는 사용자가 입력한 문자열을 반환하고, 취소 또는 Esc를 누르면 null을 반환.
- **confirm**사용자가 확인 또는 취소 버튼을 누를 때까지 메시지가 창에 보여줘. 사용자가 확인 버튼을 누르면 true를, 취소 버튼이나 Esc를 누르면 false를 반환.
